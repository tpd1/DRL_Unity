...
/// 
/// Variation of the main Agent class, designed to operate solely within the demonstration envrionment
/// </summary>
public class DemoAgent : Agent
{
    ...
    public override void Initialize()
    {
        ...
        demoManager = GetComponentInParent<DemoManager>();
    ...
    {
        demoManager.ResetAllDoorways();
        rb.velocity = Vector3.zero;
        rb.angularVelocity = Vector3.zero;
        transform.localPosition =
            demoManager.GetRandomStartPosition(); //Has to be done in lvl generator, based on start room size.
        transform.localRotation = DemoManager.GetRandomRotation(); // Pick random starting rotation
    }
